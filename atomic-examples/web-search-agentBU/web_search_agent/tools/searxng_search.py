...
class SearxNGSearchToolConfig(BaseToolConfig):
    base_url: str = get_searxng_url()
    max_results: int = get_searxng_max_results()
...
if __name__ == "__main__":
    ...
    search_tool_instance = SearxNGSearchTool(
        config=SearxNGSearchToolConfig(base_url=get_searxng_url(), max_results=get_searxng_max_results())
    )
